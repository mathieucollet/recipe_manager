        ...
        <div class="col-md-9 ml-sm-auto col-lg-10">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    @endforeach
                    <p class="card-text"><span class="font-weight-bold">Instructions {{$recipe->marked ? 'ok': 'notok'}} : </span>{{$recipe->instructions}}</p>
                    ...
                    @if ($recipe->user_id === auth()->user()->id)
                        ...
                        <form action="/recipe/{{ $recipe->id }}/edit">
                            <div type="submit" style="-webkit-appearance: initial;" onClick="javascript:this.parentNode.submit();">Modifier ma recette</div>
                        </form>
                        </a>
                    @endif
                    <div class="like-btn-svg"><input class="form-check-input"  type="checkbox" id="marked" name="marked" for="marked" value="{{$recipe->marked ? '1' : '0'}}" style="display: none;"></div>
                </div>
